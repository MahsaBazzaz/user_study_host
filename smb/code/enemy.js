...
Mario.Enemy.prototype.Draw = function(context, camera) {
    ...
    if (this.Winged) {
        ...
        if (this.Type !== Mario.Enemy.RedKoopa && this.Type !== Mario.Enemy.GreenKoopa) {
            ...
            context.translate(this.XFlip ? -THE_WIDTH : 0, this.YFlip ? -THE_HEIGHT : 0);
            context.drawImage(this.Image, (((this.WingTime / 4) | 0) % 2) * 16, 4 * 32, 16, 32,
                this.XFlip ? (THE_WIDTH - xPixel - 24) : xPixel - 8, this.YFlip ? (THE_HEIGHT - yPixel - 32) : yPixel - 8, 16, 32);
            context.restore();
            this.XFlip = !this.XFlip;
        }
    }
    ...
    if (this.Winged) {
        ...
        if (this.Type === Mario.Enemy.RedKoopa && this.Type === Mario.Enemy.GreenKoopa) {
            ...
            context.translate(this.XFlip ? -THE_WIDTH : 0, this.YFlip ? -THE_HEIGHT : 0);
            context.drawImage(this.Image, (((this.WingTime / 4) | 0) % 2) * 16, 4 * 32, 16, 32,
                this.XFlip ? (THE_WIDTH - xPixel - 24) : xPixel - 8, this.YFlip ? (THE_HEIGHT - yPixel) : yPixel - 8, 16, 32);
            context.restore();
        } else {
            context.save();
            context.scale(this.XFlip ? -1 : 1, this.YFlip ? -1 : 1);
