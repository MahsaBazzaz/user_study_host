...
Mario.TitleState.prototype.Enter = function() {
    ...
    var bgLayer0 = new Mario.BackgroundRenderer(bgGenerator.CreateLevel(), THE_WIDTH, THE_HEIGHT, 2);
    bgGenerator.SetValues(2048, 15, false, Mario.LevelType.Overground);
    var bgLayer1 = new Mario.BackgroundRenderer(bgGenerator.CreateLevel(), THE_WIDTH, THE_HEIGHT, 1);
